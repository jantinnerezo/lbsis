Public Class scheduling
    ...
    Private Sub btn_edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_edit.Click
        ...
        a = s_id.Text
        edit_sched.cbed_subject.Text = subject.Text
        edit_sched.cbedteacher.Text = tcher.Text
        edit_sched.cbed_time.Text = time.Text
        edit_sched.cbed_day.Text = adlaw.Text
        edit_sched.cbed_section.Text = sect.Text
    ...
    Private Sub on_select()
        Try
            ...
            sect.Text = sched_list.SelectedRows(0).Cells(1).Value
            subject.Text = sched_list.SelectedRows(0).Cells(2).Value
            tcher.Text = sched_list.SelectedRows(0).Cells(3).Value
            time.Text = sched_list.SelectedRows(0).Cells(4).Value
            adlaw.Text = sched_list.SelectedRows(0).Cells(5).Value
    ...
    Private Sub btn_delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_delete.Click
        ...
        ElseIf result = DialogResult.Yes Then
            ...
            gc.populate_sched(schedule, sched_list, fields)
            gc.save_logs("INSERT INTO tbl_logs (`log`)VALUES(@log)", Home.user.Text & " Deleted the Schedule of " & tcher.Text & " subject " & subject.Text)
        End If
