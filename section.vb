Public Class section
    ...
    Private Sub btn_edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_edit.Click
        a = s_id.Text
        section_edit.prev_sec.Text = sec.Text
        section_edit.prev_level.Text = glevel.Text
    ...
    Private Sub on_select()
        Try
            ...
            sec.Text = section_list.SelectedRows(0).Cells(1).Value
            glevel.Text = section_list.SelectedRows(0).Cells(2).Value
    ...
    Private Sub btn_delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_delete.Click
        ...
        ElseIf result = DialogResult.Yes Then
            ...
            gc.list_section(tbl_section, section_list, fields)
            gc.save_logs("INSERT INTO tbl_logs (`log`)VALUES(@log)", Home.user.Text & " Deleted the section " & sec.Text & " of " & glevel.Text)
        End If
    End Sub
