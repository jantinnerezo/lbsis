Public Class subject
    ...
    Private Sub btn_edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_edit.Click
        ...
        add_subject.prev_subj.Text = subject_name.Text
    ...
    Private Sub on_select()
        Try
            ...
            subject_name.Text = subject_list.SelectedRows(0).Cells(1).Value
            grade_level.Text = subject_list.SelectedRows(0).Cells(2).Value
    ...
    Private Sub btn_delete_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_delete.Click
        ...
        ElseIf result = DialogResult.Yes Then
            ...
            gc.save_logs("INSERT INTO tbl_logs (`log`)VALUES(@log)", Home.user.Text & " Deleted the " & subject_name.Text & " of " & grade_level.Text)
            refresh_subj()
        End If
    End Sub
End Class