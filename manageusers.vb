Public Class manageusers
    ...
    Private Sub btnedit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnedit.Click
        ...
        a = student.Text
        usereditform.name.Text = student.Text
    ...
    Private Sub view_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles view.Click
        ...
        GC.save_logs("INSERT INTO tbl_logs (`log`)VALUES(@log)", Home.user.Text & " Viewed the profile of " & student.Text)
    End Sub
    ...
    Private Sub delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles delete.Click
        ...
        ElseIf result = DialogResult.Yes Then
            ...
            GC.save_logs("INSERT INTO tbl_logs (`log`)VALUES(@log)", Home.user.Text & " Deleted User named " & student.Text)
