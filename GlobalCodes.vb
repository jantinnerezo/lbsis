...
Public Class GlobalCodes
    ...
    Public insert_section() As String = {"@section", "@grade_level", "@adviser"}
        ...
        Try
            ...
            If table.Rows.Count > 0 Then ' If username and password is valid
                ...
                If table.Rows(0).Item("position") = "Admin" Then
                    ...
                    Home.enroll_container.Visible = False
                    Home.btn_enroll.Visible = False
                    Home.unenroll.Visible = False
                    Home.btnedit.Visible = False
                    Home.anecdotal_btn.Visible = False
                ...
                Else
                    ...
                    Home.student_container.Visible = True
                    Home.enroll_container.Visible = False
                    Home.admin_menu.Visible = False
                    Home.teacher_menu.Visible = False
                    Home.user_name.Text = table.Rows(0).Item("username")
                    Home.position.Text = table.Rows(0).Item("position")
                    Home.studentlist_teachers.Visible = False
                    Home.anecdotal_btn.Visible = False
                    Home.studentlist_teachers.Visible = False
                    Login.Dispose()
                    Home.Show()
    ...
    Public Sub populate_history(ByVal query As String, ByVal datagridview As DataGridView, ByVal fields() As Object)
        ...
        Try
            ...
            For Each rows In table.Rows
                count = table.Rows.Count
                With datagridview
                    datagridview.Rows.Add(rows("sched_id"), rows("grade_level"), rows("section"), rows("subject"), rows("name"), rows("time"), rows("day"), rows("school_year"))
                End With
            Next
    ...
    Public Sub edit_profile(ByVal query As String)
        ...
        Try
            ...
            If table.Rows.Count > 0 Then
                ...
                editform.citizenship.Text = table.Rows(0).Item("citizenship")
                editform.religion.Text = table.Rows(0).Item("religion")
        ...
        Try
            ...
            For Each rows In table.Rows
                ...
                With datagridview
                    ...
                    datagridview.Rows.Add(rows("section_id"), rows("section"), rows("grade_level"), rows("adviser"))
    ...
    Public Sub populate_studviolation(ByVal query As String, ByVal datagridview As DataGridView, ByVal fields() As Object)
        ...
        Try
            ...
            For Each rows In table.Rows
                count = table.Rows.Count
                With datagridview
                    datagridview.Rows.Add(rows("stud_id"), rows("username"), rows("violation_id"), rows("violation"), rows("date_violation"), rows("violation_time"))
                End With
            Next
