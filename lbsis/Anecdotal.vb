Public Class Anecdotal
    ...
    Public Sub function_class()
        ...
        GC.populate_violation("SELECT tbl_studprof.stud_id, tbl_violation.username as user_name, tbl_violation.violation_id, tbl_violation.violation, tbl_violation.date_violation, tbl_violation.violation_time  FROM tbl_violation INNER JOIN tbl_login ON tbl_login.username = tbl_violation.username INNER JOIN tbl_studprof ON tbl_violation.student_id = tbl_studprof.stud_id WHERE tbl_violation.student_id = '" & student_id.Text & "' and tbl_violation.username = '" & user_name.Text & "'", violations, fields)
    ...
    Private Sub sy_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sy.SelectedIndexChanged
        GC.populate_violation("SELECT tbl_studprof.stud_id, tbl_violation.username as user_name, tbl_violation.violation_id, tbl_violation.violation, tbl_violation.date_violation, tbl_violation.violation_time  FROM tbl_violation INNER JOIN tbl_login ON tbl_login.username = tbl_violation.username INNER JOIN tbl_studprof ON tbl_violation.student_id = tbl_studprof.stud_id WHERE tbl_violation.student_id = '" & student_id.Text & "' and tbl_violation.username = '" & user_name.Text & "' and tbl_violation.school_year = '" & sy.Text & "'", violations, fields)
    End Sub
End Class