Public Class add_sched
    ...
    Public Sub checkIfExist()
        ...
        Dim query As String = "SELECT * FROM `tbl_schedule` INNER JOIN tbl_section ON tbl_section.section_id = tbl_schedule.section_id WHERE tbl_schedule.time = '" & cb_time.Text & "' and tbl_schedule.day = '" & cb_day.Text & "' and tbl_section.grade_level = '" & g.Text & "'"
